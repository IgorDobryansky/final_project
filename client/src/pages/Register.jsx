    ...
    <div>
      ...
      <div className="container">
        <form onSubmit={handleSubmit(onSubmit)} className="register-form" autoComplete="off">
          ...
          />
           {errors.email && <span className="register-span">{errors.email.message}</span>}
          </div>
          ...
          {...register('password', {
            ...
            className="registration-input"
            />
             {errors.password && <span className="register-span">{errors.password.message}</span>}
          </div>
          ...
          <span className="register-span">{errors.confirmPassword.message}</span>
        )}
          </div>
